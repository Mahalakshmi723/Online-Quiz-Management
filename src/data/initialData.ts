...
export const INITIAL_CATEGORIES: QuizCategory[] = [
  { id: 'java', name: 'Java', description: 'Core Java, OOPs concepts, multithreading & collections framework', iconName: 'Coffee', questionCount: 3, difficulty: 'Intermediate' },
  { id: 'python', name: 'Python', description: 'Dynamic scripting, data structures, decorators & generators', iconName: 'Terminal', questionCount: 3, difficulty: 'Beginner' },
  { id: 'dbms', name: 'DBMS', description: 'Database normalization, transactions, ACID properties & indexing', iconName: 'Database', questionCount: 3, difficulty: 'Intermediate' },
  { id: 'sql', name: 'SQL', description: 'Complex Joins, subqueries, aggregations & query optimization', iconName: 'FileText', questionCount: 3, difficulty: 'Beginner' },
  { id: 'html', name: 'HTML', description: 'Semantic elements, accessibility standards & DOM structure', iconName: 'Code', questionCount: 3, difficulty: 'Beginner' },
  { id: 'css', name: 'CSS', description: 'Flexbox, Grid systems, responsive styling & CSS variables', iconName: 'Palette', questionCount: 3, difficulty: 'Beginner' },
  { id: 'javascript', name: 'JavaScript', description: 'ES6+ features, closures, promises, async/await & scope', iconName: 'Cpu', questionCount: 3, difficulty: 'Intermediate' },
  { id: 'react', name: 'React', description: 'Hooks, virtual DOM, state management & component lifecycle', iconName: 'Layers', questionCount: 3, difficulty: 'Intermediate' },
  { id: 'springboot', name: 'Spring Boot', description: 'Dependency injection, REST APIs, JPA/Hibernate & MVC pattern', iconName: 'Box', questionCount: 3, difficulty: 'Advanced' },
  { id: 'aptitude', name: 'Aptitude', description: 'Quantitative reasoning, logical puzzles, data interpretation', iconName: 'Brain', questionCount: 3, difficulty: 'Intermediate' },
  { id: 'cprogramming', name: 'C Programming', description: 'Pointers, memory allocation, structures & system calls', iconName: 'Cpu', questionCount: 3, difficulty: 'Advanced' }
];
...
export const INITIAL_QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    explanation: 'Class Object is the root of the class hierarchy in Java. Every class has Object as a superclass. All objects, including arrays, implement the methods of this class.'
  },
  ...
  },
  {
    ...
    correctAnswerIndex: 2,
    explanation: 'CSS stands for Cascading Style Sheets, defining how HTML elements are to be displayed on screen, paper, or in other media.'
  },
  {
    id: 'css-3',
    categoryId: 'css',
  ...
  // Spring Boot questions
  {
    ...
    text: 'Which annotation is the combination of @Configuration, @EnableAutoConfiguration, and @ComponentScan?',
    options: ['@SpringBootApplication', '@RestController', '@EnableSpringService', '@ComponentAutoConfig'],
    correctAnswerIndex: 0,
    explanation: 'The @SpringBootApplication annotation is a convenience annotation that adds all three, booting up auto-configurations and local component scanning.'
  },
  {
    id: 'springboot-2',
    categoryId: 'springboot',
    text: 'Which port is the default embedded Tomcat server port in Spring Boot?',
    options: ['3000', '8080', '9000', '4200'],
    correctAnswerIndex: 1,
    explanation: 'By default, Spring Boot starts an embedded Apache Tomcat web server listening on port 8080.'
  },
  {
    id: 'springboot-3',
    categoryId: 'springboot',
    text: 'What does JPA stand for in Java Spring frameworks?',
    options: ['Java Pattern Architecture', 'Java Persistence API', 'Join Performance Analyst', 'Java Partition Application'],
    correctAnswerIndex: 1,
    explanation: 'JPA stands for Java Persistence API, which is a standard specification for Object-Relational Mapping (ORM) in Java.'
  },
  ...
  // Aptitude questions
  {
    id: 'aptitude-1',
    categoryId: 'aptitude',
    text: 'A car travels at 60 km/h for 2 hours and then 80 km/h for 3 hours. What is its average speed for the entire journey?',
    options: ['70 km/h', '72 km/h', '68 km/h', '75 km/h'],
    correctAnswerIndex: 1,
  ...
  },
  {
    ...
    options: ['40', '42', '45', '48'],
    correctAnswerIndex: 1,
    explanation: 'The differences between consecutive terms are increasing by 2: (6-2)=4, (12-6)=6, (20-12)=8, (30-20)=10. The next difference is 12, so 30 + 12 = 42.'
  },
  {
    id: 'aptitude-3',
    categoryId: 'aptitude',
    text: 'If 5 men can complete a piece of work in 12 days, how many days will 10 men take to complete the same work?',
    options: ['6 days', '24 days', '8 days', '10 days'],
    correctAnswerIndex: 0,
    explanation: 'Using the work formula M1 * D1 = M2 * D2: 5 * 12 = 10 * D2 => 60 = 10 * D2 => D2 = 6 days.'
  },

  // C Programming questions
  {
    id: 'c-1',
    categoryId: 'cprogramming',
  ...
  },
  {
    id: 'c-2',
    categoryId: 'cprogramming',
    text: 'Which function is used for dynamic memory allocation in C?',
    options: ['malloc()', 'alloc()', 'new()', 'create()'],
    correctAnswerIndex: 0,
    explanation: 'The malloc() function (memory allocation) allocates a specified block of memory in bytes and returns a void pointer to it.'
  },
  {
    id: 'c-3',
    categoryId: 'cprogramming',
    text: 'What is the format specifier used to print double variables in C using printf?',
    options: ['%d', '%f', '%lf', '%s'],
    correctAnswerIndex: 2,
    explanation: '"%lf" is the standard format specifier used to print double values in C, whereas "%f" is typically for single-precision float.'
  }
];
...
export const INITIAL_ATTEMPTS: QuizAttempt[] = [
  {
    ...
    percentage: 100,
    timeTakenSeconds: 45,
    selectedAnswers: { 'python-1': 3, 'python-2': 1, 'python-3': 2 },
    markedForReview: [],
    userEmail: 'alex.carter@edu.org'
  },
  {
    id: 'attempt-2',
    categoryId: 'react',
    ...
    selectedAnswers: { 'react-1': 2, 'react-2': 1, 'react-3': 0 }, // wrong on react-3 (selected 0, correct 1)
    markedForReview: ['react-3'],
    userEmail: 'alex.carter@edu.org'
  },
  {
    id: 'attempt-3',
    ...
    percentage: 66.7,
    timeTakenSeconds: 78,
    selectedAnswers: { 'dbms-1': 2, 'dbms-2': 2, 'dbms-3': 2 }, // wrong on dbms-2 (selected 2, correct 3)
    markedForReview: [],
    userEmail: 'alex.carter@edu.org'
  }
];
...
export const loadState = <T>(key: string, defaultValue: T): T => {
  try {
    const saved = localStorage.getItem(`quiz_app_${key}`);
    if (saved !== null) {
...
export const saveState = <T>(key: string, value: T): void => {
  try {
    localStorage.setItem(`quiz_app_${key}`, JSON.stringify(value));
  } catch (e) {
